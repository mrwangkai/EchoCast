...
- [x] T66 — Your Notes empty state — Added Listen→Capture→Remember empty state card to Home Notes section. Shows when recentNotes.isEmpty with three-column illustrative design (🎧 Listen, ✎ Capture on mintAccent bg, Mini note preview Remember). Updated section header from "Recent Notes" to "Notes". Uses Color.white.opacity(0.07) for dividers and border. (Commit: 7282b21)
