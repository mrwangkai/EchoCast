...
- [ ] T19 (P0): "Add note" sheet automatically dismisses itself when tapping on "add note" icon on the mini player while an episode is playing (commit history: 0e52239, 5b60839, 61f4bb8)
